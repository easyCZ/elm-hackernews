...
var _easyCZ$elm_hackernews$Main$viewValidation = function (model) {
	var _p0 = _elm_lang$core$Native_Utils.eq(model.password, model.passwordAgain) ? {ctor: '_Tuple2', _0: 'yellow', _1: 'OK'} : {ctor: '_Tuple2', _0: 'red', _1: 'Password do not match!'};
	var color = _p0._0;
	var message = _p0._1;
	return A2(
...
var _easyCZ$elm_hackernews$Main$update = F2(
...
var _easyCZ$elm_hackernews$Main$Model = F3(
	function (a, b, c) {
		return {username: a, password: b, passwordAgain: c};
	});
var _easyCZ$elm_hackernews$Main$model = A3(_easyCZ$elm_hackernews$Main$Model, '', '', '');
var _easyCZ$elm_hackernews$Main$PasswordAgain = function (a) {
	return {ctor: 'PasswordAgain', _0: a};
};
var _easyCZ$elm_hackernews$Main$Password = function (a) {
	return {ctor: 'Password', _0: a};
};
var _easyCZ$elm_hackernews$Main$Name = function (a) {
	return {ctor: 'Name', _0: a};
};
var _easyCZ$elm_hackernews$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('Name Here 22'),
						_elm_lang$html$Html_Events$onInput(_easyCZ$elm_hackernews$Main$Name)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_easyCZ$elm_hackernews$Main$Password)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$type$('password'),
						_elm_lang$html$Html_Attributes$placeholder('password again again'),
						_elm_lang$html$Html_Events$onInput(_easyCZ$elm_hackernews$Main$PasswordAgain)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_easyCZ$elm_hackernews$Main$viewValidation(model)
			]));
};
var _easyCZ$elm_hackernews$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _easyCZ$elm_hackernews$Main$model, view: _easyCZ$elm_hackernews$Main$view, update: _easyCZ$elm_hackernews$Main$update})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _easyCZ$elm_hackernews$Main$main === 'undefined' ? null : _easyCZ$elm_hackernews$Main$main);
